...
d0[d0 < 5] = stepright # change for consistent later
d0[d0 >= 5] = stepleft
...
#distavg = nt*(2*(pright) - 1)
distavg = nt*stepleft + (stepright - stepleft)*pright*nt
...
distvar = nt*pright*pleft*((stepright - stepleft)**2)
...
#-----------------------------Saving the figure---------------------------------
fig.savefig("/Users/Parker/Desktop/Walks/Newplots/1DRW1000UWNew.png", format = "png", dpi=800)
